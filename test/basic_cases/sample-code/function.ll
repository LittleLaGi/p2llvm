; ModuleID = './test/basic_cases/sample-code/function.c'
source_filename = "./test/basic_cases/sample-code/function.c"
...
; Function Attrs: noinline nounwind optnone uwtable
define dso_local i32 @dot(i32 %0, i32 %1, i32 %2, i32 %3) #0 {
  %5 = alloca i32, align 4
...
define dso_local i32 @main() #0 {
  ...
  %6 = call i32 @product(i32 %4, i32 %5)
  store i32 %6, i32* @gv, align 4
  %7 = load i32, i32* @gv, align 4
  %8 = load i32, i32* %2, align 4
  %9 = load i32, i32* %3, align 4
  %10 = call i32 @product(i32 %8, i32 %9)
  %11 = add nsw i32 %7, %10
  ...
  %20 = call i32 @dot(i32 %16, i32 %17, i32 %18, i32 %19)
  store i32 %20, i32* @gv, align 4
  ret i32 0
}
